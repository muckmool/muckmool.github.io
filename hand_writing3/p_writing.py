...
# 붓글씨
tx0, ty0, tx1, ty1, wd = 2, 2, 2, 2, 15

# 네이밍펜
#tx0, ty0, ty1, ty2, wd = 2, 2, 2, 2, 10

# 싸인펜
#tx0, ty0, ty1, ty2, wd = 1, 1, 1, 1, 3


def change_boot():
    global tx0, ty0, tx1, ty1, wd
    tx0, ty0, ty1, ty2, wd = 2, 2, 2, 2, 15
...
def mouseMove(event):
    ...
    if(x0 is not 0 and y0 is not 0):
        canvas.create_line(x0-tx0, y0-ty0, x1+tx1, y1+ty1, fill="black", width = wd)
    x0 = event.x
    y0 = event.y
