...
label7 = Label(tk,text='한글', font=font1).grid(row=5, column=0)

label5 = Label(tk,text='일본', font=font1).grid(row=6, column=0)
label6 = Label(tk,text='발음', font=font1).grid(row=7, column=0)
...
entry_book.delete(0,"end")
entry_book.insert(tkinter.END, "San Guo Yan Yi")
