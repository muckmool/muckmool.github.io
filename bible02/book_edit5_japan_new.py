...
entry2 = Text(tk, width=45, height =1, font=font5)
entry3 = Text(tk, width=90, height =1, font=font4)
...
entry7 = Text(tk, width=73, height =1, font=font2)
...
entry_book.delete(0,"end")
entry_book.insert(tkinter.END, "nhk news")
