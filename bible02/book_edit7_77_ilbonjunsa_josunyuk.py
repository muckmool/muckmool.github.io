...
def book_name_search():
    book_list = [
                    ...
                    "japan_book_data/75_nhk_news.json",
                    "japan_book_data/76_jong_yi_kiwon.json",
                    "japan_book_data/77_ilbonjunsa_josunyuk.json",
...
entry_book.delete(0,"end")
entry_book.insert(tkinter.END, "Japan News")
