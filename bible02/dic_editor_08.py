...
label2 = Label(tk,text='한자', font=font1).grid(row=1,column=0)
label11 = Label(tk,text='일본', font=font1).grid(row=2,column=0)
label9 = Label(tk,text='풀이', font=font1).grid(row=3,column=0)
...
btn6 = Button(tk,text='이전',bg='black',fg='white',command=previous).grid(row=5,column=2)
...
btn1 = Button(tk,text='수정',bg='black',fg='white',command=update).grid(row=6,column=2)
btn7 = Button(tk,text='write',bg='black',fg='white',command=write).grid(row=6,column=3)
