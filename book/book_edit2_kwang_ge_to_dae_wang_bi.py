...
def new():
    with open ("kwang_ge_to_dae_wang_bi.json", "r", encoding = 'utf-8') as f:
        data = json.load(f)
    ...
    if(seq != None):
        ...
        f = open("kwang_ge_to_dae_wang_bi.json", 'w', encoding = 'utf-8')
        f.write(string)
        f.close()
...
entry1 = Entry(tk, width=120, font=font1)
entry2 = Text(tk, width=120, height =7, font=font1)
entry3 = Text(tk, width=120, height =7, font=font1)
entry4 = Text(tk, width=120, height =7, font=font1)
