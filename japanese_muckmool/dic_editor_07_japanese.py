...
def search_japan():
    ...
    for i in range(0,max):
        #print(data['dictionary'][i]['hangul'])
        if(data['dictionary'][i]['japan'] == h_temp ):
            result = i
            entry01.delete(0,"end")
            entry01.insert(0,"조회완료")
            entry00.delete(0,"end")
...
label11 = Label(tk,text='일본', font=font1).grid(row=2,column=0)
label2 = Label(tk,text='한자', font=font1).grid(row=3,column=0)
label3 = Label(tk,text='1', font=font1).grid(row=4,column=0)
label4 = Label(tk,text='2', font=font1).grid(row=5,column=0)
label5 = Label(tk,text='3', font=font1).grid(row=6,column=0)
label6 = Label(tk,text='4', font=font1).grid(row=7,column=0)
label7 = Label(tk,text='5', font=font1).grid(row=8,column=0)
label8 = Label(tk,text='6', font=font1).grid(row=9,column=0)
label9 = Label(tk,text='풀이', font=font1).grid(row=10,column=0)
label10 = Label(tk,text='중국', font=font1).grid(row=11,column=0)
...
entry62.grid(row=7,column=2)
entry72.grid(row=8,column=2)
entry82.grid(row=9,column=2)
...
btn8 = Button(tk,text='일본',bg='black',fg='white',command=search_japan).grid(row=2,column=2)
btn8 = Button(tk,text='한자',bg='black',fg='white',command=search_hanja).grid(row=3,column=2)
